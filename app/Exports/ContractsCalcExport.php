...
class ContractsCalcExport implements FromCollection, WithStyles, ShouldAutoSize
{
    ...
    protected array $fieldMapping = [
        ...
        'Տոկոս' => 'contract.daily_interest_sum',
        'Արդյունավետ տոկոս' => 'contract.daily_effective_sum',
...
//                ->first();
            ...
            if ($classHistory) {
                ...
                $contractData['risk_weight_percent'] = $client->classification->risk_weight ?? 0;
                $contractData['reserve_percent'] = $client->classification->reserve_percent ?? 0;
            }

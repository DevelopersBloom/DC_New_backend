                        ...
                        foreach ($client->contracts as $contract) {
                            ...
                            if ($client->classification->name === 'loss') {
                                ...
                                if ($amount16605PS > 0) {
                                    ...
                                    $lossDoc = DocumentJournal::create([
                                        ...
                                        'debit_partner_id' => $ruleLossReserve->resolveDebitPartnerId($contract) ?? $clientId,
                                        'credit_partner_id' => $ruleLossReserve->resolveCreditPartnerId($contract) ?? $clientId,
                                ...
                                if ($amount16200Debit > 0) {
                                    ...
                                    $lossEffectiveDoc = DocumentJournal::create([
                                        ...
                                        'debit_partner_id' => $ruleLossEffective->resolveDebitPartnerId($contract) ?? $clientId,
                                        'credit_partner_id' => $ruleLossEffective->resolveCreditPartnerId($contract) ?? $clientId,
                                ...
                                if ($amount16201NIDebit > 0) {
                                    ...
                                    $loss16201NI = DocumentJournal::create([
                                        ...
                                        'debit_partner_id' => $ruleLoss->resolveDebitPartnerId($contract) ?? $clientId,
                                        'credit_partner_id' => $ruleLoss->resolveCreditPartnerId($contract) ?? $clientId,
                            ...
                            if (!empty($amount16605PC) && $oldClassificationName === 'standard') {
                                ...
                                $classificationDoc = DocumentJournal::create([
                                    ...
                                    'debit_partner_id' => $ruleClassification->resolveDebitPartnerId($contract) ?? $clientId,
                                    'credit_partner_id' => $ruleClassification->resolveCreditPartnerId($contract) ?? $clientId,

            ...
            if ($payed_penalty > 0) {
                ...
                if ($rulePenalty) {
                    ...
                    $journalDocPenalty = DocumentJournal::create([
                        ...
                        'debit_partner_id' => $rulePenalty->resolveDebitPartnerId($contract),
                        'credit_partner_id' => $rulePenalty->resolveCreditPartnerId($contract),
    ...
    private function handleAccountingForPartial($contract, $partialAmount, $date,$deal_id=null,$cash = null)
    {
        ...
        if ($ruleMother && $partialAmount > 0) {
            ...
            $journalDoc = DocumentJournal::create([
                ...
                'debit_partner_id' => $ruleMother->resolveDebitPartnerId($contract),
                'credit_partner_id' => $ruleMother->resolveCreditPartnerId($contract),

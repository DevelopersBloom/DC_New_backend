...
//                73015, 16605PC,
                ...
                $this->postCorrectionEntry(
                    ...
                    creditAccountId:$credit,
                    amount:         abs($diffPC),
                    documentType:   $diffPC > 0 ? DocumentJournal::PROVIDED_AMOUNT_CHANGE : DocumentJournal::RESERVE_GENERAL_AMOUNT,
...
//                    : [$rule->debit_account_id, $rule->credit_account_id];
                ...
                $this->postCorrectionEntry(
                    ...
                    amount:         abs($diffPS),
                    documentType:   $diffPS > 0 ? DocumentJournal::PROVIDE_SPECIAL_AMOUNT_CHANGE : DocumentJournal::RESERVE_SPECIAL_AMOUNT,

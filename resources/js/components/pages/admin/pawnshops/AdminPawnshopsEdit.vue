<template>
    <div class="overflow-x-auto sm:rounded-lg container mx-auto pt-10 p-4">
        ...
        <div class="flex items-center justify-between">
            <h2 class="text-2xl dark:text-white">Փոփոխել գրավատան տվյալները</h2>
            <fwb-button color="yellow" tag="router-link" :href="'/admin/pawnshops/cashbox/' + form.id">Դրամարկղ</fwb-button>
        </div>
...
export default {
    ...
    setup() {
        ...
        const submitForm = (e) => {
            e.preventDefault();
            getAxios().post('/api/admin/update-pawnshop',{...form.value}).then((res) => {

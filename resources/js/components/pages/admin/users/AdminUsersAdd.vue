<template>
    <div class="overflow-x-auto sm:rounded-lg container mx-auto pt-10 p-4">
        <div class="flex items-center">
            <h2 class="text-2xl dark:text-white">Ավելացնել օգտատեր</h2>
        ...
        <form class="mt-4" @submit="submitForm">
            ...
            <div class="mb-4">
                ...
                <input v-model="form.password" type="text" id="password" autocomplete="off"
                       class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                       focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700
                       dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500
                       dark:focus:border-blue-500" required>
...
export default {
    ...
    setup() {
        ...
        const submitForm = (e) => {
            e.preventDefault();
            getAxios().post('/api/admin/create-user',{...form.value}).then((res) => {
                if(res.data.success === 'success'){
                    alertSuccess('Օգտատերը ավելացված է')

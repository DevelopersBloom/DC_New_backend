...
//        Route::get('/transactions/reports/export', [ReportController::class, 'getFirstReport']);
        ...
        Route::get('/loan-ndm/attraction/{journalId}', [LoanNdmController::class, 'getLoanAttraction']);
        Route::put('/loan-ndm/attraction', [LoanNdmController::class, 'updateLoanAttraction']);
        ...
        Route::get('/loan-ndm/remaining/{id}', [ChartOfAccountController::class, 'remainingAmount']);
...
//        Route::get('/export', [ContractControllerNew::class, 'exportContracts']);
        ...
        Route::post('/calculate-interest', [ContractControllerNew::class, 'calculateContractInterest']);

...
//        Route::get('/export', [ContractControllerNew::class, 'exportContracts']);
        ...
        Route::get('/{id}/registry/l001', [CreditRegistryController::class, 'downloadL001'])->middleware('can:download_contract_file');
        Route::get('/{id}/credit-registry/l002', [CreditRegistryController::class, 'downloadL002'])->middleware('can:download_contract_file');
        Route::post('/{id}/credit-registry/l001/send', [CreditRegistryController::class, 'sendL001'])->middleware('can:download_contract_file');
